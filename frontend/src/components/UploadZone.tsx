 ...
 *
 * Integration seam: both handleDrop and handleFileChange currently just flip
 * to "processing". Replace setState("processing") in those handlers with your
 * actual upload logic (e.g. POST /api/upload with FormData) and derive the
 * processing state from the in-flight request instead.
 */

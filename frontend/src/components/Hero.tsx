 ...
 */
const DOC_TYPES = ["NDA", "Lease", "Vendor contract", "Employment", "SaaS terms"];
    ...
    <section className="pt-32 pb-20 px-6 max-w-6xl mx-auto">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div
            className="inline-flex items-center gap-2 bg-amber-light text-amber-dark text-xs font-medium px-3 py-1.5 rounded-full mb-6 animate-fade-up anim-delay-1"
          >
          ...
          <h1
            className="text-[52px] leading-[1.08] font-light tracking-tight mb-6 animate-fade-up anim-delay-2"
          >
            ...
            contract in
            <br />
            <span className="font-serif-italic text-amber">60 seconds.</span>
          </h1>

          <p
            className="text-[16px] text-muted leading-relaxed mb-8 max-w-md animate-fade-up anim-delay-3"
          >
            Upload a PDF or DOCX. Get a structured 1-page brief with key dates,
            obligations, red flags, and renewal clauses — in plain English.
          </p>

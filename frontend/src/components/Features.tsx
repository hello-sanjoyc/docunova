...
const FEATURES = [
  {
    ...
    description:
      "Claude reads the full contract and pulls out what matters — obligations, dates, penalties, and red flags — in plain English.",
    iconBg: "bg-amber-light",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#C8852A" strokeWidth="1.5">
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#B03A2E" strokeWidth="1.5">
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#3A6B4E" strokeWidth="1.5">
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#7A7569" strokeWidth="1.5">
